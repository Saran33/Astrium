...
feed_icon = 'images/PWE_logo_132x132.eps'

#Import csv list of tickers:
tickers = pd.read_csv('tickers.csv')
tickers = pd.DataFrame(tickers)
tickers = tickers.drop('Security Name',axis=1)
ticks = tickers['Ticker'].to_list()

def load_daily(ticker):
    """
    Load daily data for the chosen ticker
    """
...
def load_intraday(ticker):
    """
    Load intraday data for the chosen ticker
    """
...
app.layout = html.Div(children=[
                ...
                html.Div(children=[
                    ...
                    html.Div(children=[
                        ...
                        html.Img(src= feed_icon, height="30px")
...
# Number statistics & OHLC for each day
            html.Div(children= [ 
                html.Div(children=[
                    #Stats box 
                    html.Div(children=[
...
def ohlc_graph(value):
    """
    This callback generates an OHLC chart for the selected ticker 
    """
    df = load_daily(value)
